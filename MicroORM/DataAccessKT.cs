...
namespace MicroORM
{
    public class DataAccessKT
    {
        ...
        public DataAccessKT(string connectionKey)
        {
            _connection = GetConnection(connectionKey);
        }

        public DataAccessKT(DbConnection connection)
        {
            _connection = connection;
        }

        public DataAccessKT(DataAccess dal)
        {
        ...
        public DataAccessKT SetCommand(string commandText)
        {
            return SetCommand(commandText, CommandType.Text);
        }

        public DataAccessKT SetCommand(string commandText, CommandType commandType)
        {
            return SetCommand(commandText, commandType, null);
        }

        public DataAccessKT SetCommand(string commandText, CommandType commandType, params DbParameter[] parameters)
        {
            return SetCommand(GetCommand(commandText, commandType, parameters));
        }

        public DataAccessKT SetCommand(DbCommand command)
        {
            _command = command;
            return this;
        }
        ...
        public DataAccessKT AddParameter(string name, object value)
        {
            return AddParameter(_command, name, value);
        }

        public DataAccessKT AddParameter(string name, DbType dbtype, object value)
        {
            return AddParameter(_command, name, dbtype, value);
        }

        public DataAccessKT AddParameter(DbCommand command, string name, object value)
        {
        ...
        public DataAccessKT AddParameter(DbCommand command, string name, DbType dbtype, object value)
        {
            DbParameter para = command.CreateParameter();
            para.ParameterName = name;
            para.DbType = dbtype;
        ...
        public DataAccessKT AddParameter(DbParameter para)
        {
            return AddParameter(_command, para);
        }

        public DataAccessKT AddParameter(DbCommand command, DbParameter para)
        {
        ...
        public DataSet ExecuteQuery2(string cQuery)
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(ConfigurationManager.ConnectionStrings["DatabaseConnection"].ToString()))
            {
                try
                {
        ...
        public static DataTable ExecuteQuery(string cQuery)
        {
            ...
            using (MySqlConnection conn = new MySqlConnection(ConfigurationManager.ConnectionStrings["DatabaseConnection"].ToString()))
            {
                ...
                {
                    conn.Open();
                    using (MySqlDataAdapter SqDA = new MySqlDataAdapter(cQuery, conn))
                    {
                        SqDA.Fill(dt);
                    }
                    return dt;
        ...
        public static DataTable ExecuteParaQuery(string cQuery, MySqlParameter[] paramenters)
        {
            DataTable dt = new DataTable();
            using (MySqlConnection conn = new MySqlConnection(ConfigurationManager.ConnectionStrings["DatabaseConnection"].ToString()))
            {
        ...
        public static DataTable ExecuteProcedure(string cProcedureName, MySqlParameter [] paramenters)
        {
            DataTable dt = new DataTable();
        ...
        public string ExecuteSclar(string cProcedureName, MySqlParameter[] paramenters)
        {
            using (MySqlConnection conn = new MySqlConnection(ConfigurationManager.ConnectionStrings["DatabaseConnection"].ToString()))
            {
                try
